<template>
	<div class="w-full h-full flex justify-center items-center bg-black overflow-y-auto">
		<div class="grid grid-cols-1 md:grid-cols-2 gap-8">
			<div class="w-56 h-56 flex flex-col items-center justify-between shadow-lg rounded-lg p-2 bg-white hover:bg-gray-100 relative">
			...
			<div
				class="w-56 h-56 flex flex-col items-center justify-between shadow-lg rounded-lg p-2 bg-white hover:bg-gray-100 relative">
				<div class="absolute p-3 -top-10 left-4 bg-sky-500 rounded-lg"> 
					<div class="w-20 h-20 px-5 py-5 object-cover rounded-lg bg-sky-500">
